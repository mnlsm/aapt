...
class BasicStringPiece {
 public:
  ...
  BasicStringPiece<TChar> substr(typename BasicStringPiece<TChar>::const_iterator begin,
	  typename BasicStringPiece<TChar>::const_iterator end) const;
...
template <typename TChar>
const size_t BasicStringPiece<TChar>::npos;
...
inline BasicStringPiece<TChar> BasicStringPiece<TChar>::substr(
	typename BasicStringPiece<TChar>::const_iterator begin,
	typename BasicStringPiece<TChar>::const_iterator end) const {

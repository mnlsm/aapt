...
public:
    ...
    struct attribute_entry {
		...
		bool operator<(const attribute_entry& other) const {
			if (ns != other.ns) {
				return ns < other.ns;
			}
			if (name != other.name) {
			...
			if (nameResId != other.nameResId) {
				return nameResId < other.nameResId;
			}
			if (namePoolIdx != other.namePoolIdx) {
				return namePoolIdx < other.namePoolIdx;
			}

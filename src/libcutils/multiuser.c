...
int multiuser_get_user_id(int uid) {
    return uid / AID_USER_OFFSET;
}

appid_t multiuser_get_app_id(int uid) {
    return uid % AID_USER_OFFSET;
}

int multiuser_get_uid(int user_id, appid_t app_id) {
    return (user_id * AID_USER_OFFSET) + (app_id % AID_USER_OFFSET);
}

int multiuser_get_cache_gid(int user_id, appid_t app_id) {
...
int multiuser_get_ext_gid(int user_id, appid_t app_id) {
    if (app_id >= AID_APP_START && app_id <= AID_APP_END) {
...
int multiuser_get_ext_cache_gid(int user_id, appid_t app_id) {
    if (app_id >= AID_APP_START && app_id <= AID_APP_END) {
...
int multiuser_get_shared_gid(int user_id, appid_t app_id) {
    if (app_id >= AID_APP_START && app_id <= AID_APP_END) {
...
int multiuser_get_shared_app_gid(int uid) {

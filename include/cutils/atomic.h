...
#define ANDROID_ATOMIC_INLINE static _inline
#endif
...
volatile std::atomic_int_least32_t* to_stdatomic_int_least32_t(volatile const int32_t* addr) {
#ifdef __cplusplus
...
{
    volatile std::atomic_int_least32_t* a = to_stdatomic_int_least32_t(addr);
 ...
 * atomic_thread_fence (typically with std::memory_order_release,

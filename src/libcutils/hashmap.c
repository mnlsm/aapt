...
#endif
static _inline int hashKey(Hashmap* map, void* key) {
    int h = map->hash(key);
...
static _inline size_t calculateIndex(size_t bucketCount, int hash) {
...
static _inline bool equalKeys(void* keyA, int hashA, void* keyB, int hashB,

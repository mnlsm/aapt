...
struct EocdRecord {
 ...
 public:
	 EocdRecord() { memset(this, '\0', sizeof(*this)); };
...
struct CentralDirectoryRecord {
 ...
 public:
	 CentralDirectoryRecord() { memset(this, '\0', sizeof(*this)); }
...
struct LocalFileHeader {
 ...
 public:
	 LocalFileHeader() { memset(this, '\0', sizeof(*this)); }
...
struct DataDescriptor {
 ...
 public:
	 DataDescriptor(){ memset(this, '\0', sizeof(*this)); }
